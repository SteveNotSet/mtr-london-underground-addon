...
public interface MyBlockEntityTypes {
	...
	RegistryObject<BlockEntityType<TunnelA2Signal.TileEntityTunnelSignalLight1>> TUNNEL_A2_SIGNAL = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(TunnelA2Signal.TileEntityTunnelSignalLight1::new, MyBlocks.TUNNEL_A2_SIGNAL.get()));
	...
	RegistryObject<BlockEntityType<BlockRoundel4.TileEntityBlockRoundel4>> BLOCK_ROUNDEL4_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel4.TileEntityBlockRoundel4::new, MyBlocks.BLOCK_ROUNDEL_4.get()));
	RegistryObject<BlockEntityType<BlockRoundel4Big.TileEntityBlockRoundel4Big>> BLOCK_ROUNDEL4_BIG_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel4Big.TileEntityBlockRoundel4Big::new, MyBlocks.BLOCK_ROUNDEL_4_BIG.get()));
	RegistryObject<BlockEntityType<BlockRoundel4BigEven.TileEntityBlockRoundel4BigEven>> BLOCK_ROUNDEL4_BIG_EVEN_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel4BigEven.TileEntityBlockRoundel4BigEven::new, MyBlocks.BLOCK_ROUNDEL_4_BIG_EVEN.get()));

	RegistryObject<BlockEntityType<BlockRoundel5.TileEntityBlockRoundel5>> BLOCK_ROUNDEL5_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel5.TileEntityBlockRoundel5::new, MyBlocks.BLOCK_ROUNDEL_5.get()));
	RegistryObject<BlockEntityType<BlockRoundel5Big.TileEntityBlockRoundel5Big>> BLOCK_ROUNDEL5_BIG_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel5Big.TileEntityBlockRoundel5Big::new, MyBlocks.BLOCK_ROUNDEL_5_BIG.get()));
	RegistryObject<BlockEntityType<BlockRoundel5BigEven.TileEntityBlockRoundel5BigEven>> BLOCK_ROUNDEL5_BIG_EVEN_TILE_ENTITY = new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(BlockRoundel5BigEven.TileEntityBlockRoundel5BigEven::new, MyBlocks.BLOCK_ROUNDEL_5_BIG_EVEN.get()));
